...
<head>
    ...
    <title><?php echo C('title');?>-修改幻灯片</title>
            ...
            <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Slides/doedit',array('id'=>$arr['id']));?>" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="pic" required value = "<?php echo ($arr["pic"]); ?>" id = "pic">
