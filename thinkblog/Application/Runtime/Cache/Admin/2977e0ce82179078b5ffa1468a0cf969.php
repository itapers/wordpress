...
<head>
    ...
    <title><?php echo C('title');?>-添加邀请码</title>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" class="form-horizontal" action="<?php echo U('Yaoqing/doProduction');?>">
                        <div class="form-group has-success"><label class="col-sm-4 control-label">邀请码前缀（填写英文就好 如：XXS）</label>
